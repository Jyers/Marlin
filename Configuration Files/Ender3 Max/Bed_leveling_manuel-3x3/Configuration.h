...
#define STRING_CONFIG_H_AUTHOR "L.Christophe" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Max-Manual Bed Level"
 ...
 * (Do not enable this for manual EXT-UI UBL!)
 */

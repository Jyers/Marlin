...
void CrealityDWINClass::Draw_Print_ProgressRemain() {
  ...
  if (eeprom_settings.time_format_textual) {
    DWIN_Draw_String(false, false, DWIN_FONT_MENU, GetColor(eeprom_settings.remain_time, Color_White), Color_Bg_Black, 192, 187, (char*)"h");
    DWIN_Draw_String(false, false, DWIN_FONT_MENU, GetColor(eeprom_settings.remain_time, Color_White), Color_Bg_Black, 216, 187, (char*)"m");
  }
  else {
    DWIN_Draw_String(false, false, DWIN_FONT_MENU, GetColor(eeprom_settings.remain_time, Color_White), Color_Bg_Black, 192, 187, (char*)":");
  }
}
...
void CrealityDWINClass::Draw_Print_ProgressElapsed() {
  ...
  if (eeprom_settings.time_format_textual) {
    DWIN_Draw_String(false, false, DWIN_FONT_MENU, GetColor(eeprom_settings.elapsed_time, Color_White), Color_Bg_Black, 58, 187, (char*)"h");
    DWIN_Draw_String(false, false, DWIN_FONT_MENU, GetColor(eeprom_settings.elapsed_time, Color_White), Color_Bg_Black, 82, 187, (char*)"m");
  }
  else {
    DWIN_Draw_String(false, false, DWIN_FONT_MENU, GetColor(eeprom_settings.elapsed_time, Color_White), Color_Bg_Black, 58, 187, (char*)":");
  }
}
...
void CrealityDWINClass::Draw_Popup(const char *line1, const char *line2,const char *line3, uint8_t mode, uint8_t icon/*=0*/) {
  ...
  process = mode;
  Clear_Screen();
  DWIN_Draw_Rectangle(0, GetColor(eeprom_settings.highlight_box, Color_Bg_Window), 13, 59, 259, 351);
    ...
    case ColorSettings:
        ...
        case COLORSETTINGS_SPLIT_LINE:
          ...
          case COLORSETTINGS_REMAIN_TIME:
           if (draw) {
            Draw_Menu_Item(row, ICON_MaxSpeed, (char*)"Remain Time");
          ...
          case COLORSETTINGS_ELAPSED_TIME:
           if (draw) {
            Draw_Menu_Item(row, ICON_MaxSpeed, (char*)"Elapsed Time");

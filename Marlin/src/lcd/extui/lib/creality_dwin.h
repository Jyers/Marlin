...
enum popupID : uint8_t {
  Pause, Stop, Resume, SaveLevel, ETemp, ConfLevel, Level, Home, MoveWait, Heating, PIDHotend, PIDBed, Complete, FilLoad, FilChange, UI, TempWarn, Runout
};
...
enum colorID : uint8_t {
  Default, White, Blue, Yellow, Red, Green, Magenta, Brown
};
...
public:
  struct EEPROM_Settings { // use bit fields to save space, max 48 bytes
    ...
    uint8_t remain_time : 3;
    uint8_t elapsed_time : 3;
    uint8_t status_bar_text : 3;
    uint8_t status_area_text : 3;
    uint8_t coordinates_text : 3;
  } eeprom_settings;

  char *color_names[8] = {(char*)"Default",(char*)"White",(char*)"Blue",(char*)"Yellow",(char*)"Red",(char*)"Green",(char*)"Magenta",(char*)"Brown"};

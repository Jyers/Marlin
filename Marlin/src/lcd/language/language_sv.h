...
namespace Language_sv {
  ...
  PROGMEM Language_Str MSG_DISABLE_STEPPERS                = _UxGT("Inaktivera Stegmotorer");
  PROGMEM Language_Str MSG_DEBUG_MENU                      = _UxGT("Debugmeny");
  ...
  PROGMEM Language_Str MSG_SET_HOME_OFFSETS                = _UxGT("Sätt Hemoffset");
  ...
  PROGMEM Language_Str MSG_TRAMMING_WIZARD                 = _UxGT("Justeringswizard");
  ...
  PROGMEM Language_Str MSG_LASER_POWER                     = _UxGT("Laserstyrka");
  PROGMEM Language_Str MSG_SPINDLE_POWER                   = _UxGT("Spindelstyrka");
  ...
  PROGMEM Language_Str MSG_SWITCH_PS_ON                    = _UxGT("Sätt På Nätdel");
  PROGMEM Language_Str MSG_SWITCH_PS_OFF                   = _UxGT("Stäng Av Nätdel");
  ...
  PROGMEM Language_Str MSG_MESH_EDITOR                     = _UxGT("Nätredigerare");
  ...
  PROGMEM Language_Str MSG_M48_OUT_OF_BOUNDS               = _UxGT("Sond Utanför Gränser");
  ...
  PROGMEM Language_Str MSG_UBL_MANUAL_MESH                 = _UxGT("Skapa Nät Manuellt");
  ...
  PROGMEM Language_Str MSG_UBL_SET_TEMP_BED                = _UxGT("Bäddtemp");
  PROGMEM Language_Str MSG_UBL_BED_TEMP_CUSTOM             = _UxGT("Bäddtemp");
  PROGMEM Language_Str MSG_UBL_SET_TEMP_HOTEND             = _UxGT("Munstycke Temp");
  PROGMEM Language_Str MSG_UBL_HOTEND_TEMP_CUSTOM          = _UxGT("Munstycke Temp");
  PROGMEM Language_Str MSG_UBL_MESH_EDIT                   = _UxGT("Redigera Nät");
  ...
  PROGMEM Language_Str MSG_UBL_MESH_HEIGHT_ADJUST          = _UxGT("Justera Näthöjd");
  ...
  PROGMEM Language_Str MSG_UBL_MAP_TYPE                    = _UxGT("Karttyp");
  PROGMEM Language_Str MSG_UBL_OUTPUT_MAP                  = _UxGT("Utmatning Nät Karta");
  ...
  PROGMEM Language_Str MSG_UBL_STORAGE_MESH_MENU           = _UxGT("Lagra Nät");
  PROGMEM Language_Str MSG_UBL_STORAGE_SLOT                = _UxGT("Minneskorsöppning");
  PROGMEM Language_Str MSG_UBL_LOAD_MESH                   = _UxGT("Ladda BäddNät");
  PROGMEM Language_Str MSG_UBL_SAVE_MESH                   = _UxGT("Spara BäddNät");
  ...
  PROGMEM Language_Str MSG_CONTROLLER_FAN_AUTO_ON          = _UxGT("Autoläge");
  PROGMEM Language_Str MSG_CONTROLLER_FAN_SPEED            = _UxGT("Hastighet");
  PROGMEM Language_Str MSG_CONTROLLER_FAN_DURATION         = _UxGT("Period");
  ...
  PROGMEM Language_Str MSG_PID_AUTOTUNE_DONE               = _UxGT("PID Tuning Slutförd");
  ...
  PROGMEM Language_Str MSG_FILAMENT_DIAM                   = _UxGT("Filamentdiam.");
  PROGMEM Language_Str MSG_FILAMENT_DIAM_E                 = _UxGT("Filamentdiam. *");
  ...
  PROGMEM Language_Str MSG_SETTINGS_STORED                 = _UxGT("Inställningar Lagrade");
  PROGMEM Language_Str MSG_MEDIA_UPDATE                    = _UxGT("Uppdatera Media");
  ...
  PROGMEM Language_Str MSG_INFO_SCREEN                     = _UxGT("Infoskärm");
  PROGMEM Language_Str MSG_PREPARE                         = _UxGT("Förbered");
  PROGMEM Language_Str MSG_TUNE                            = _UxGT("Justera");
  PROGMEM Language_Str MSG_POWER_MONITOR                   = _UxGT("Övervakning Ström");
  ...
  PROGMEM Language_Str MSG_PAUSE_PRINT                     = _UxGT("Pausa Utskrift");
  ...
  PROGMEM Language_Str MSG_CONTROL_RETRACT_RECOVER         = _UxGT("Dra tillbaka filament. mm");
  PROGMEM Language_Str MSG_CONTROL_RETRACT_RECOVER_SWAP    = _UxGT("Ändra Tillbakadragning t. mm");
  PROGMEM Language_Str MSG_CONTROL_RETRACT_RECOVERF        = _UxGT("Tillbakadragning. V");
  PROGMEM Language_Str MSG_CONTROL_RETRACT_RECOVER_SWAPF   = _UxGT("Ändra Tillbakadragning. V");
  PROGMEM Language_Str MSG_AUTORETRACT                     = _UxGT("Automatisk Tillbakadragning");
  ...
  PROGMEM Language_Str MSG_SINGLENOZZLE_PRIME_SPEED        = _UxGT("Grundhastighet");
  PROGMEM Language_Str MSG_SINGLENOZZLE_RETRACT_SPEED      = _UxGT("Tillbakadragning Hastighet");
  ...
  PROGMEM Language_Str MSG_TOOL_MIGRATION                  = _UxGT("Verktygsmigration");
  ...
  PROGMEM Language_Str MSG_FILAMENTCHANGE                  = _UxGT("Byt Filament");
  PROGMEM Language_Str MSG_FILAMENTCHANGE_E                = _UxGT("Byt Filament *");
  PROGMEM Language_Str MSG_FILAMENTLOAD                    = _UxGT("Ladda Filament");
  PROGMEM Language_Str MSG_FILAMENTLOAD_E                  = _UxGT("Ladda *");
  PROGMEM Language_Str MSG_FILAMENTUNLOAD                  = _UxGT("Lossa Filament");
  ...
  PROGMEM Language_Str MSG_BLTOUCH_MODE_STORE              = _UxGT("Läge-Lagring");
  ...
  PROGMEM Language_Str MSG_ENDSTOP_ABORT                   = _UxGT("Slutstopp Avbruten");
  PROGMEM Language_Str MSG_HEATING_FAILED_LCD              = _UxGT("Uppvärmning Misslyckad");
  PROGMEM Language_Str MSG_ERR_REDUNDANT_TEMP              = _UxGT("Fel: REDUNDANT TEMP");
  PROGMEM Language_Str MSG_THERMAL_RUNAWAY                 = _UxGT("Temperaturskydd Utlöst!");
  PROGMEM Language_Str MSG_THERMAL_RUNAWAY_BED             = _UxGT("Temperaturskydd Utlöst! Bädd");
  PROGMEM Language_Str MSG_THERMAL_RUNAWAY_CHAMBER         = _UxGT("Temperaturskydd Utlöst! Kammare");
  ...
  PROGMEM Language_Str MSG_DELTA_HEIGHT_CALIBRATE          = _UxGT("Sätt Deltahöjd");
  ...
  PROGMEM Language_Str MSG_INFO_PRINTER_MENU               = _UxGT("Info Skrivare");
  ...
  PROGMEM Language_Str MSG_INFO_STATS_MENU                 = _UxGT("Skrivarstatistik");
  PROGMEM Language_Str MSG_INFO_BOARD_MENU                 = _UxGT("Moderkortsinfo");
  ...
  PROGMEM Language_Str MSG_INFO_RUNAWAY_OFF                = _UxGT("Temperaturövervakning: AV");
  PROGMEM Language_Str MSG_INFO_RUNAWAY_ON                 = _UxGT("Temperaturövervakning: PÅ");
  PROGMEM Language_Str MSG_HOTEND_IDLE_TIMEOUT             = _UxGT("Temperaturövervakning Hetände Tidsgräns");
  ...
  PROGMEM Language_Str MSG_KILL_EXPECTED_PRINTER           = _UxGT("INKORREKT SKRIVARE!");
    ...
    PROGMEM Language_Str MSG_INFO_PRINT_FILAMENT           = _UxGT("Extruderad filamentlängd Totalt");
  #else
  ...
  PROGMEM Language_Str MSG_FILAMENT_CHANGE_HEADER_LOAD     = _UxGT("LADDA FILAMENT");
  PROGMEM Language_Str MSG_FILAMENT_CHANGE_HEADER_UNLOAD   = _UxGT("LOSSA FILAMENT");
  PROGMEM Language_Str MSG_FILAMENT_CHANGE_OPTION_HEADER   = _UxGT("ÅTERGÅ:");
  ...
  PROGMEM Language_Str MSG_RUNOUT_SENSOR                   = _UxGT("Filamentsensor");
  PROGMEM Language_Str MSG_RUNOUT_DISTANCE_MM              = _UxGT("Filamentsensor avstånd mm");
  PROGMEM Language_Str MSG_KILL_HOMING_FAILED              = _UxGT("Homing Misslyckad");
  PROGMEM Language_Str MSG_LCD_PROBING_FAILED              = _UxGT("Sondering Misslyckad");

  PROGMEM Language_Str MSG_MMU2_CHOOSE_FILAMENT_HEADER     = _UxGT("VÄLJ FILAMENT");
  PROGMEM Language_Str MSG_MMU2_MENU                       = _UxGT("MMU");
  PROGMEM Language_Str MSG_KILL_MMU2_FIRMWARE              = _UxGT("Uppdatera MMU Firmware!");
  PROGMEM Language_Str MSG_MMU2_NOT_RESPONDING             = _UxGT("MMU Fel - Svarar inte.");
  ...
  //
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_INIT          = _UxGT(MSG_3_LINE("Vänta på", "filamentbyte", "att börja"));
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_INSERT        = _UxGT(MSG_3_LINE("Sätt in filament", "och tryck på knappen", "för att fortsätta"));
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_UNLOAD        = _UxGT(MSG_2_LINE("Väntar på", "filamentutmatning"));
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_LOAD          = _UxGT(MSG_2_LINE("Väntar på", "filamentladdning"));
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_PURGE         = _UxGT(MSG_2_LINE("Väntar på", "filamentutrensning"));
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_CONT_PURGE    = _UxGT(MSG_2_LINE("Klicka för att slutföra", "filamentutmatning"));
  ...
  PROGMEM Language_Str MSG_TMC_HOMING_THRS                 = _UxGT("Sensorlös Homing");
  ...
  PROGMEM Language_Str MSG_AUTO_CALIBRATE                  = _UxGT("Auto Kalibrera");
    ...
    PROGMEM Language_Str MSG_HEATER_TIMEOUT                = _UxGT("Tidsgräns uppnådd för temperaturminskning. Tryck ok för att återvärma och igen för att fortsätta.");
  #else
    PROGMEM Language_Str MSG_HEATER_TIMEOUT                = _UxGT("Tidsgräns för Värmare");
  #endif
  PROGMEM Language_Str MSG_REHEAT                          = _UxGT("Förvärm");
  PROGMEM Language_Str MSG_REHEATING                       = _UxGT("Förvärmning...");
